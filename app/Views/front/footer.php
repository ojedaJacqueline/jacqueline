  ...
  <footer
    ...
    <div class="container p-4 pb-0">
        ...
        <div class="row">
          ...
          <p><a class="text-white" href="<?php echo base_url('terminos');?>">Términos y usos</a></p>
        </div>
          <!-- Grid column -->
...
<!-- Twitter -->
    ...
    <br>
    <!-- Copyright -->
    <div class="text-center p-3"style="background-color: rgba(5, 0, 5, 4.2)" >
      © 2022 taller1:
      <a class="text-white" href="#">miPrimerAplicacionWeb.com</a>
    </div>
